...
public class ReturnByDeathMod implements ModInitializer {
    ...
    public void onInitialize() {
        LOGGER.info("[Return By Death v1.2.5] Initializing - 'I will save you, no matter how many times I have to die.'");
        ...
        ServerPlayConnectionEvents.JOIN.register((handler, sender, server) -> {
            ...
            player.sendMessage(Text.literal("\u00a7d\u00a7l[Return By Death v1.2.5] \u00a7r\u00a77A save point is created every \u00a7e" + interval + "s\u00a77. Die, and rewind."), false);
        ...
        LOGGER.info("[Return By Death v1.2.5] Initialization complete. May the Witch of Envy have mercy.");
    }
